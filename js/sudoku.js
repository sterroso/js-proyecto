...
const sudokuBoard = SudokuBoard.getBoard('medium');

const player = Player.getPlayer('sergio.terroso@gmail.com', 'Sergio', 'Terroso Cabrera');

const sudokuGame = SudokuGame.getSudokuGame(sudokuBoard, player);

sudokuBoard.draw(sudokuBoardContainer);

console.log(sudokuGame.getLastStartTimestamp());